# FEP Historical Lineage

> **Epistemic Status:** Historical notes for context. **Via Resonantiae** is **2026 new construction**, not lineage claim.

---

## Via Resonantiae (Part VII Track B)
...
## East-West Borrowings (Metaphor Only)
...
1. **Literal plane geography**
2. **Entity ontology** — angels, demons, HGA as independent beings
3. **Proof from ritual success** — gnosis is Pathos/Gnosis, not evidence
4. **Doctrinal authority** — Crowley, Regardie, Blavatsky inspire, do not govern
5. **False lineage** — no secret transmission claim
6. **Guru economy** — anti-guru clause in Liber V

---

## What FEP / VR Takes (Phenomenology)

| Source | Element |
|--------|---------|
| Theosophy | Planes as filter layers (I10) |
| GD | Structured imaginal work |
| Thelema | Star vocabulary |
| Jung | Active imagination |
| BFC/FEO research | Coupling, bleed, integration language |

---

## Novel System Statement

**Via Resonantiae** and FEP are **2026 constructions** for contemplative use:
...
See [`via_resonantiae/EPISTEMIC_CHARTER.md`](via_resonantiae/EPISTEMIC_CHARTER.md).
